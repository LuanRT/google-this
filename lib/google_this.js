...
const search = (query, options = {
  ...
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      var born_date =
      $(utils.kno_panel_born_date_selector)[0] || undefined;
      if (born_date) {
      ...
      $(utils.kno_panel_videogame_release_date_selector)[0] ||
      undefined;
      ...
      $(utils.kno_panel_film_googleusers_rating_selector)[0] ||
      undefined;
      ...
      if (word != '') {
        ...
        final_data.dictionary.phonetic = (phonetic === '') ? 'n/a': $(phonetic).text();
