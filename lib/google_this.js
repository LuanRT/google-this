    ...
    axios
      ...
      .then((res) => {
        ...
        var videogame_release_date = $(
          utils.kno_panel_videogame_release_date_selector
        )[0];
        ...
        var videogame_composer = $(
          utils.kno_panel_videogame_composer_selector
        )[0];
        ...
        var google_users_rating = $(
          utils.kno_panel_film_googleusers_rating_selector
        )[0];
        ...
        var founded_date = $(
          utils.kno_panel_organization_founded_date_selector
        )[0];
        if (founded_date) {
        ...
        var parent_organization = $(
          utils.kno_panel_organization_parent_selector
        )[0];
        ...
        var headquarters = $(
          utils.kno_panel_organization_headquarters_selector
        )[0];
        if (headquarters) {
        ...
        var subsidiaries = $(
          utils.kno_panel_organization_subsidiaries_selector
        )[0];
        if (subsidiaries) {
        ...
        var featured_snippet = $(utils.featured_snippet_desc_selector[0])[0]
          ...
          ? $($(utils.featured_snippet_desc_selector[2])[0]).text()
          : undefined;
