...
class Converters {
  constructor($) {
    ...
    const unit_converter_formula = $(Constants.SELECTORS.UNIT_CONVERTER_FORMULA).prop('innerText') || '';
    ...
    const currency_converter_input = $(Constants.SELECTORS.CURRENCY_CONVERTER_INPUT).prop('innerText') || '';
    const currency_converter_output = $(Constants.SELECTORS.CURRENCY_CONVERTER_OUTPUT).prop('innerText') || '';
