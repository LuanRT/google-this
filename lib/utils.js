...
const formatHtml = (data) => {
  return (
    data
      ...
      .replace(
        /yUTMj MBeuO ynAwRc PpBGzd YcUVQe/g,
        "yUTMj MBeuO ynAwRc gsrt PpBGzd YcUVQe"
      )
  );
};
...
const selectors = {
  ...
  kno_panel_videogame_engine_selector:
    'div[data-attrid="hw:/collection/games:engine"] > div > div > div > span > a[class="fl"]',
  kno_panel_videogame_platforms_selector:
    'div[data-attrid="kc:/cvg/computer_videogame:platform"] > div > div > div > span',
  kno_panel_videogame_awards_selector:
    'div[data-attrid="kc:/award/award_winner:awards"] > div > div > div > span > a[class="fl"]',
  kno_panel_webfacts_series_selector:
    'div[data-attrid="ss:/webfacts:seri"] > div > div > div > span > a',

  kno_panel_award_nominations_selector:
    'div[data-attrid="kc:/award/award_winner:nominations"] > div > div > div > span > a[class="fl"]',

  kno_panel_song_lyrics_selector:
    'div[data-attrid="kc:/music/recording_cluster:lyrics"] > div > g-expandable-container > div > div > div',
  kno_panel_song_artist_selector:
    'div[data-attrid="kc:/music/recording_cluster:artist"] > div > div > div > span > a[class="fl"]',
  kno_panel_song_ft_artist_selector:
    'div[data-attrid="kc:/music/recording_cluster:featured artist"] > div > div > div > span > a[class="fl"]',
  kno_panel_song_album_selector:
    'div[data-attrid="kc:/music/recording_cluster:first album"] > div > div > div > span > a[class="fl"]',
  kno_panel_song_release_date_selector:
    'div[data-attrid="kc:/music/recording_cluster:release date"] > div > div > div',

  kno_panel_film_director_selector:
    'div[data-attrid="kc:/film/film:director"] > div > div > div > span > a',
  kno_panel_film_screenplay_selector:
    'div[data-attrid="kc:/film/film:screenplay"] > div > div > div > span > a',
  ...
  kno_panel_film_release_date_selector:
