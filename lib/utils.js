...
const formatHtml = (data) => {
  ...
  /* Renaming important classes so we can get consistent results */
...
const selectors = {
  ...
  featured_snippet_url_selector: [ 'a[class="truncation-information"]', 'a[class="sXtWJb gsrt"]', 'a[class="sXtWJb gsrt amp_r"]' ],
  ...
  /** “People also ask” **/
  paa_selector: [ 'div[class="wWOJcd"] > div > span', 'div[class="s75CSd"]','div[class="s75CSd u60jwe gduDCb"] > span' ],
